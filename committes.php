...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    <h1><b>Committees and Cells</b></h1>
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   About Us   </a> /Committees 
    </div>
</div>
...
<section class="committees" style="font-family: Georgia, serif;">
    <h2 style="color: red;"><b>Institutional Committees and Cells</b></h2>
    <table class="committee-table">
      <tr>
        <td>
          <a href="science-club.php" class="committee-link">
            <i class="fas fa-flask"></i>
            <p>Science Club</p>
          </a>
        </td>
        <td>
          <a href="maths-club.php" class="committee-link">
            <i class="fas fa-square-root-alt"></i>
            <p>Maths Club</p>
          </a>
        </td>
        <td>
          <a href="arts-club.php" class="committee-link">
      ...
      <tr>
        <td>
          <a href="Et-club.php" class="committee-link">
            <i class="fas fa-laptop-code"></i>
            <p>Educational Technology Club</p>
          </a>
        </td>
        <td>
          <a href="eco-club.php" class="committee-link">
            <i class="fas fa-leaf"></i>
            <p>Eco Club</p>
          </a>
        </td>
        <td>
          <a href="guidance-counseling.php" class="committee-link">
            <i class="fas fa-comments"></i>
            <p>Guidance & Counseling Cell</p>
          </a>
        </td>
      </tr>
      <tr>
        <td>
          <a href="grievance-redressal.php" class="committee-link">
            <i class="fas fa-bullhorn"></i>
            <p>Grievance Redressal Cell</p>
          </a>
        </td>
        <td>
          <a href="anti-ragging.php" class="committee-link">
            <i class="fas fa-ban"></i>
            <p>Anti-Ragging Committee</p>
          </a>
        </td>
        <td>
          <a href="youth-red-cross.php" class="committee-link">
            <i class="fas fa-first-aid"></i>
            <p>Youth Red Cross Society</p>
          </a>
        </td>
      </tr>
      <tr>
        <td>
          <a href="pta.php" class="committee-link">
            <i class="fas fa-handshake"></i>
            <p>Parent Teachers Association</p>
          </a>
        </td>
        <td>
          <a href="library-committee.php" class="committee-link">
            <i class="fas fa-book"></i>
            <p>Library Advisory Committee</p>
          </a>
        </td>
        <td>
          <a href="alumni-association.php" class="committee-link">
