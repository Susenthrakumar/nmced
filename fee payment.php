...
<head>
    ...
    <title>NMC</title>
    <link rel="stylesheet" href="css/fee_payment.css">
</head>
<body>
...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Academics  </a>  / Fee Payment
    </div>
</div>


<div class="fee-container" style="font-family: 'Merriweather', serif;">
    <h1 style="color: red;">Fees Payment</h1>
    <p>To facilitate fee payments, use the provided bank details or scan the QR code for convenience.</p>
    
    <!-- Show QR Code Button -->
    <div class="button-container" style="font-size: 22px;">
        <button id="showQRButton" onclick="toggleQR()">Show QR Code</button>
    </div>
    
    <!-- QR Code Section (Initially Hidden) -->
    <div class="qr-container" id="qrContainer" style="display: none;">
        <img src="images/payment/QR CODE.jpeg" alt="QR Code" class="qr-image">
    </div>
    ...
    <div class="details">
        <table class="details-table">
            <tr>
                <td style="font-size: 25px;"><strong>Account Name</strong></td>
                <td><b>:</b></td>
                <td  style="font-size: 25px;">Nehru Memorial College of Education</td>
            </tr>
            <tr>
                <td style="font-size: 25px;"><strong>Account Number</strong></td>
                <td><b>:</b></td>
                <td style="font-size: 25px;">63633070000425</td>
            </tr>
            <tr>
                <td style="font-size: 25px;"><strong>Account Type</strong></td>
                <td><b>:</b></td>
                <td style="font-size: 25px;">Current Account</td>
            </tr>
            <tr>
                <td style="font-size: 25px;"><strong>Bank</strong></td>
                <td><b>:</b></td>
                <td style="font-size: 25px;">Canara Bank</td>
            </tr>
            <tr>
                <td style="font-size: 25px;"><strong>Branch</strong></td>
                <td><b>:</b></td>
                <td style="font-size: 25px;">Puthanampatti</td>
            </tr>
            <tr>
                <td style="font-size: 25px;"><strong>IFSC</strong></td>
                <td><b>:</b></td>
                <td style="font-size: 25px;">CNRB0016363</td>
            </tr>
        </table>
    </div>
</div>
<script src="js/FEE_QRCODE.js"></script>
