...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Committees   </a>  / Library Advisory Committee
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        ...
        <a href="anti-ragging.php" style="text-decoration: none;"><button >Anti-Ragging Committee</button></a>
        ...
        <a href="library-committee.php" style="text-decoration: none;"><button class="active">Library Advisory Committee</button></a>
    ...
    <div class="main-content">
        <h2 class="infra-title" style="font-family: Georgia, serif;  text-align: center; color: rgb(201, 9, 9)"><b>Library Advisory Committee</b></h2>
        <h2 class="details-title" style="font-family: Georgia, serif; color: rgb(201, 9, 9)"><b>About</b></h2>
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>The students are well oriented with the use of the library at the beginning of the academic session.</li>
            <li>The rules framed or modified from time to time are obeyed properly.</li>
            <li>The reading materials supporting theory and research are procured well in time to cater to the diverse needs of the readers.</li>
            <li>The subscription of journals, publications, and magazines is looked into carefully.</li>
            <li>That the library transactions are recorded and maintained properly.</li>
            <li>That the technology supporting library activities is serviced, upgraded, and optimally used.</li>
            <li>That the infrastructural needs of the library are upgraded as per the requirement.</li>
        </ul> 
        <h2 class="details-title" style="font-family: Georgia, serif; color: rgb(201, 9, 9)"><b>Objectives</b></h2>
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>To involve all the faculty members in the selection of books pertaining to their optional subjects.</li>
            <li>To take decisions on the purchase of books.</li>
            <li>To visit libraries of other institutions and recommend the addition of new journals.</li>
            <li>To organize exhibitions of booksellers for the purchase of books.</li>
            <li>To display book flaps of new arrivals.</li>
            <li>To suggest extra working hours of the library when needed.</li>
            <li>To take action for violation of norms.</li>
            <li>To get recommendations for the purchase of new books from teachers and students.</li>
            <li>To bring a partially automated, well-stacked library with an OPAC.</li>
            <li>To hold meetings to discuss important issues regarding the library.</li>
        </ul>   
        <h2 class="infra-title"  style="font-family: Georgia, serif;  color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>Library Advisory Committee Members</b></h2>
                <table>
                    <thead>
                        <tr>
                            <th>S.No</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Mr. T. SURESH, Assistant Professor in Computer Science</td>
                            <td>Member</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">4</td>
                            <td>Mr. T. PARAMESHWARI, Assistant Professor in Tamil</td>
                            <td>Member</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">5</td>
                            <td>Mr. C. HARIHARAN, Assistant professor in English</td>
                            <td>Member</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">6</td>
                            <td>Mr. P. PANDIYAN (Parent)</td>
                            <td>Member</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">7</td>
                            <td>Mr. A. SELLADURAI (Parent)</td>
                            <td>Member</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">7</td>
                            <td>Mr. P. ALLIMUTHU (Parent)</td>
                            <td>Member</td>
                        </tr>
                    </tbody>
                </table>
