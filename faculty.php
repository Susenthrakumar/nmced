...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   About Us   </a> / Faculties
    </div>
</div>
...
<section class="faculty-section" style="font-family: Georgia, serif">
    <h2>Teaching Faculties</h2>
    <table class="faculty-table">
        <tr>
            <td>
                <a href="#"  style="text-decoration: none;">
                    <div class="faculty-card">
                        <img src="images/faculty/Dr.R. KARPAGAM.jpg" alt="">
                        <h3>Dr.R. KARPAGAM</h3>
                        <p>Designation: In-Charge Principal</p>
                    </div>
                </a>
            </td>
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mr.S. ANANTHAKUMAR.jpg" alt="">
                    <h3>Mr.S. ANANTHAKUMAR</h3>
            ...
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mrs. S. ANBUKKARASI.jpg" alt="">
                    <h3>Mrs. S. ANBUKKARAS</h3>
        ...
        <tr>
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mr.R. ANANDKUMAR.jpg" alt="">
                    <h3>Mr.R. ANANDKUMAR</h3>
                    <p>Designation: Associate Professor</p>
                </div>
                </a>
            </td>
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mrs. R. MYTHILY.jpg" alt="">
                    <h3>Mrs. R. MYTHILY</h3>
                    <p>Designation: Associate Professor</p>
                </div>
                </a>
            ...
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mrs. T. PARAMESHWARI.jpg" alt="">
                    <h3>Mrs. T. PARAMESHWARI</h3>
                    <p>Designation: Associate Professor</p>
                </div>
                </a>
            </td>
        ...
        <tr>
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mr. T. SURESH.jpg" alt="">
                    <h3>Mr. T. SURESH</h3>
                    <p>Designation: Associate Professor</p>
                </div>
                </a>
            ...
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mr. M. KANNAIYAN.jpg" alt="">
                    <h3>Mr. M. KANNAIYAN</h3>
                    <p>Designation: Associate Professor</p>
                </div>
                </a>
            </td>
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mrs.R. KANADHASAN.jpg" alt="">
                    <h3>Mrs.R. KANADHASAN</h3>
                    <p>Designation: Associate Professor</p>
                </div>
                </a>
            </td>
        ...
        <tr>
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mr. T. SENTHIL KUMAR.jpg" alt="">
                    <h3>Mr. T. SENTHIL KUMAR</h3>
                    <p>Designation: Physical Director</p>
                </div>
                </a>
            </td>
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mrs.M. JANCI RANI.jpg" alt="">
                    <h3>Mrs.M. JANCI RANI</h3>
                    <p>Designation: Associate Professor</p>
                </div>
                </a>
            </td>
            <td>
                <a href="#" style="text-decoration: none;">
                <div class="faculty-card">
                    <img src="images/faculty/Mrs. V. MALATHI.jpg" alt="">
                    <h3>Mrs. V. MALATHI</h3>
                    <p>Designation: Associate Professor</p>
                </div>
                </a>
