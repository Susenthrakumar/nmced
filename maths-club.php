...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Committees   </a>  / Maths Club
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        ...
        <a href="maths-club.php" style="text-decoration: none;"><button class="active">Maths Club</button></a>
    ...
    <div class="main-content">
        <h2 class="infra-title" style="font-family: Georgia, serif;  text-align: center; color: rgb(201, 9, 9)"><b>Maths Club</b></h2>
        ...
        <p style="font-family: Georgia, serif; text-align: justify; color: black; margin-top: 0px; text-indent: 30px;">
            The Mathematics Club of our college was commenced in 2021. All the student Teachers of department of mathematics are member of this club. The president and secretary are selected by the members every year.
        </p>       
        <h3 class="details-title" style="font-family: Georgia, serif; color: rgb(201, 9, 9)"><b>Objectives</b></h3>
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>To increase the interest in Mathematics among the Student Teachers.</li>
            <li>To give a great and wide exposure..</li>
            <li>To develop the problem solving abilities and the leadership qualities.</li>
            <li>To encourage the Student Teachers to teach Mathematics very well during their School Internship Training Programme so as to help the school students to secure centum in Mathematics..</li>
        </ul>
        <h3 class="details-title" style="font-family: Georgia, serif; color: rgb(201, 9, 9)"><b>Club Activities</b></h3>
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>Organizing workshops, Guest lectures, Group Discussion and Quiz Programmes.</li>
            <li>Special lectures are given by the eminent personalities in the field of Mathematics.</li>
            <li>Clebreate the birthday of great personalities in Mathematics.</li>
        </ul>
        <h2 class="infra-title"  style="font-family: Georgia, serif;   color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>Maths Club Members</b></h2>
                <table>
                    <thead>
                        <tr>
                            <th>S.No</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Mr. R. KANNADHASAN, M.Sc., M.Phil., M.Ed.,</td>
                            <td>Coordinator</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">2</td>
                            <td>Mr. M. RAGUNATH, Assistant Professor in Education</td>
                            <td>Members</td>
                        </tr>
                        <tr>
