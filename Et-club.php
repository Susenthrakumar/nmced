...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Committees  </a>  / ET Club
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        ...
        <a href="Et-club.php" style="text-decoration: none;"><button class="active">Educational Technology Club</button></a>
    ...
    <div class="main-content">
        <h2 class="infra-title" style="font-family: Georgia, serif;  text-align: center; color: rgb(201, 9, 9)"><b>Educational Technology Club</b></h2>
        ...
        <p style="font-family: Georgia, serif; text-align: justify; color: black; margin-top: 0px; text-indent: 30px;">
            ET CLUB is a Technical Association of student teachers run by and for the students of Department of Computer Science Education. ET Club organizes for the student Teachers of the non computer science department in our college, who are weak in utilization of computer skills while teaching. At the end of the course all the student Teachers of our college are well equipped with basic skills on Educational Technology.
        </p>
        <h2 class="infra-title" style="font-family: Georgia, serif;   color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>Club activities</b></h2>
        <p style="font-family: Georgia, serif; text-align: justify; color: black; margin-top: 0px; text-indent: 30px;">
            To train the Non computer science student Teachers through computer science student Teachers about the basic computer utilization such as Microsoft Word, Excel, PowerPoint, Google class, Google Meet, etc. - to all the student Teachers through group activities.
        </p>        
        <h2 class="infra-title"  style="font-family: Georgia, serif;   color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>ET Club Members</b></h2>
                <table>
                    <thead>
                        <tr>
                            <th>S.No</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Mr. S. SURESH, Assistant Professor in Computer Science</td>
                            <td>Member (Staff)</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">2</td>
                            <td>Mr. A. VAIYADURAI, Assistant Professor in Physical Science</td>
                            <td>Member (Staff)</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">3</td>
                            <td>Mr.K.SANTHANAM, Assistant Professor in Tamil</td>
                            <td>Member (Staff)</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">4</td>
                            <td>Mr.K.KARTHIGEYAN, Assistant Professor in English</td>
                            <td>Member (Staff)</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">5</td>
                            <td>A. REXCITA MARY, II Year (CS)</td>
                            <td>Secretary</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">6</td>
                            <td>M. NANDHINI, II Year (CS)</td>
                            <td>Treasurer</td>
                        </tr>
                        <tr>
