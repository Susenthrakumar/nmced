...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Committees   </a>  / Science Club
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        <a href="Science-club.php" style="text-decoration: none;"><button class="active">Science Club</button></a>
    ...
    <div class="main-content">
        <h2 class="infra-title" style="font-family: Georgia, serif;  text-align: center; color: rgb(201, 9, 9)"><b>Science Club</b></h2>
        ...
        <p style="font-family: Georgia, serif; text-align: justify; color: black; margin-top: 0px; text-indent: 30px;">
            The Nehru Memorial College of Education science Club functions from 2020. The purpose of the club is to make awareness of the relevance of science in modern society and to facilitate student teachers success in the discipline of science and related disciplines where an understanding of science is important. The club also provide training to the student teachers through utilizing in scientific method of problem solving in class room and develop their skills like manipulative, communicative, leadership etc. also gives an opportunity for students with similar interests and career goals to meet and socialize
        </p>       
        <h3 class="details-title" style="font-family: Georgia, serif; color: rgb(201, 9, 9)"><b>Club Activities</b></h3>
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">
            <li>Arranging talks and lectures of the distinguished speakers, subject experts and outside guests.</li>
            <li>Arranging debates, group discussions, seminars and workshops, paper reading and quiz contests.</li>
            <li>Arranging excursions and short trips for members to places of scientific interests.</li>
            <li>Decorating the walls of the classrooms and laboratory with scientific pictures and charts preferably by students themselves.</li>
            <li>Improvising and preparing handmade apparatus, charts and models.</li>
            <li>Celebrating science days.</li>
            <li>Holding science fairs and exhibitions.</li>
        </ul>
        <h2 class="infra-title"  style="font-family: Georgia, serif;   color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>Science Club Members</b></h2>
                <table>
                    <thead>
                        <tr>
                            <th>S.No</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Mrs. G. GEETHAMARY, Assistant Professor in Physical Science</td>
                            <td>Coordinator</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">2</td>
                            <td>Mr. P. SENTHIL, Assistant Professor in Bio-Science</td>
                            <td>Member (Staff)</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>S. HARIDHARANI, II Year (Physical Science)</td>
                            <td>Secretary</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">5</td>
                            <td>S. RAMESHBABU, II Year (Physical Science)t</td>
                            <td>Treasurer</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">6</td>
                            <td>I Year & II Year Science Students</td>
                            <td>Members</td>
                        </tr>
                    </tbody>
                </table>
