...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        <a href="Student details.php" style="text-decoration: none;"><button>Student Details</button></a>
        <a href="syllabus.php" style="text-decoration: none;"><button  class="active"> Regulations & Syllabus</button></a>
    ...
    <div class="content">
        ...
        <div class="box-contain">
            <div class="body-contain">
                <a class="calendar-file-link" href="documents/syllabus/B.Ed. Regulations & Syllabus Semester Pattern.pdf" target="_blank">Regulations & Syllabus.pdf</a>
            </div>
        </div>        
    </div>
</div>
