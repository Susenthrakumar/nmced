...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    <h1><b>Scholarships</b></h1>
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /  Academics  </a>  / Scholarships
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        ...
        <a href="syllabus.php" style="text-decoration: none;"><button>Syllabus</button></a>
        <a href="calendar.php" style="text-decoration: none;"><button>Academic Calendar</button></a>
        <a href="scholarships.php" style="text-decoration: none;"><button class="active">Scholarships</button></a>
    </div>
