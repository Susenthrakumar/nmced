...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Committees   </a>  / Parent Teachers Association
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        ...
        <a href="pta.php" style="text-decoration: none;"><button class="active">Parent Teachers Association</button></a>
    ...
    <div class="main-content">
        <h2 class="infra-title" style="font-family: Georgia, serif;  text-align: center; color: rgb(201, 9, 9)"><b>Parent Teachers Association</b></h2>
        ...
        <p style="font-family: Georgia, serif; text-align: justify; color: black; margin-top: 0px; text-indent: 30px;">
            Parent Teacher Association has been functions from 2019-2020 for the welfare of students, teachers and society.
        </p>
        ...
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>To achieve cent percent results.</li>
            <li>To accept suggestions and guidance from parents for preparing good teachers.</li>
            <li>To bring out co-operation and close relationship between parents, teachers, and management.</li>
            <li>To encourage PTA for giving suggestions and advice to teachers and students for promoting National Integration.</li>
            <li>To appreciate and encourage teachers and students who bring name and fame to the institution at National and International level.</li>
        </ul>   
        <h2 class="infra-title"  style="font-family: Georgia, serif;  color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>PTA Members</b></h2>
                <table>
                    <thead>
                        <tr>
                            <th>S.No</th>
