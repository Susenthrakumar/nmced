...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Committees   </a>  / Grievance Redressal Cell
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        ...
        <a href="grievance-redressal.php" style="text-decoration: none;"><button class="active">Grievance Redressal Cell</button></a>
    ...
    <div class="main-content">
        <h2 class="infra-title" style="font-family: Georgia, serif;  text-align: center; color: rgb(201, 9, 9)"><b>Grievance Redressal Cell</b></h2>
        ...
        <p style="font-family: Georgia, serif; text-align: justify; color: black; margin-top: 0px; text-indent: 30px;">
            To realize the primary needs of the students, a Grievance Redressal Cell has been constituted in the college. The Grievance Redressal Cell holds meetings periodically and takes steps to redress the grievances if any. The Principal is the chairperson of the cell. Anyone with a genuine grievance may approach the members in person, or the Principal. In case the student is unwilling to appear in person, grievances may be dropped in the grievance box earmarked for the purpose.
        </p>
        ...
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>Provide an exclusive platform to Women employees and Girl students to air their grievances either in person or in writing.</li>
            <li>Devise welfare schemes for women employees and girl students.</li>
            <li>To establish dignity, self esteem and respect for women without any gender bias In the system.</li>
        </ul>   
        <h2 class="infra-title"  style="font-family: Georgia, serif;   color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>Grievance Redressal Cell Members</b></h2>
                <table>
                    <thead>
                        <tr>
                            <th>S.No</th>
