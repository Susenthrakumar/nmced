...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /  Academics  </a>  / Student Details 
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        <a href="Student details.php" style="text-decoration: none;"><button class="active">Student Details</button></a>
        <a href="syllabus.php" style="text-decoration: none;"><button>Regulations & Syllabus</button></a>
        <a href="calendar.php" style="text-decoration: none;"><button>Academic Calendar</button></a>
        <a href="scholarships.php" style="text-decoration: none;"><button>Scholarships</button></a>
    </div>
    ...
    <div class="content">
        ...
        <div class="box-contain">
            <div class="body-contain">
                <a class="calendar-file-link" href="documents/students details/2023 - 2025 BATCH STUDENTS.pdf" target="_blank" >2023 - 2025 Batch Students Details</a>
            </div>
        </div>        
        <div class="box-contain">
            <div class="body-contain">
                <a class="calendar-file-link" href="documents/students details/2022 - 2024 BATCH STUDENTS.pdf" target="_blank" >2022 - 2024 Batch Students Details</a>
            </div>
        </div>
        <div class="box-contain">
            <div class="body-contain">
                <a class="calendar-file-link" href="#"  target="_blank" >2021 - 2023 Batch Students Details</a>
            </div>
        </div>
        <div class="box-contain">
            <div class="body-contain">
                <a class="calendar-file-link" href="#" target="_blank" > 2020 - 2022 Batch Students Details</a>
            </div>
        </div>
        <div class="box-contain">
            <div class="body-contain">
                <a class="calendar-file-link" href="#" target="_blank" >2019 - 2021 Batch Students Details</a>
            </div>
        </div>
    </div>
</div>
