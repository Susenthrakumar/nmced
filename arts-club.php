...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Committees  </a>  / Arts Club
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        ...
        <a href="arts-club.php" style="text-decoration: none;"><button class="active">Arts Club</button></a>
    ...
    <div class="main-content">
        <h2 class="infra-title" style="font-family: Georgia, serif;  text-align: center; color: rgb(201, 9, 9)"><b>Arts Club</b></h2>
        ...
        <p style="font-family: Georgia, serif; text-align: justify; color: black; margin-top: 0px; text-indent: 30px;">
            The art club engages with the college as a creative center for the arts. It recognizes the diversity of students, clubs, and programs with a goal of creative interaction. Our club exists to give the students an artistic outlet and to enrich and foster an interest for art and personal expression through art. The College provides ample opportunities to develop talents in different forms of art like skit, music, elocution, painting, drawing, and other forms of arts. In addition to the activities of the Arts club, students are encouraged to take part in inter collegiate competitions organized by various schools and colleges.
        </p>       
        <h3 class="details-title" style="font-family: Georgia, serif; color: rgb(201, 9, 9)"><b>Aim & Objectives</b></h3>
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>To bring out the latent talents of the student Teachers.</li>
            <li>Develop and demonstrate skills in critical and analytical thinking through effective speaking, writing, and performing on topics in the fine arts.</li>
            <li>Create, perform, and experience work in a variety of art forms with a high level of comprehension and appreciation.</li>
        </ul>
        <h3 class="details-title" style="font-family: Georgia, serif; color: rgb(201, 9, 9)"><b>Functions</b></h3>
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>Conducting the competitions for various discipline students in the college.</li>
            <li>Developing the extra-curricular activities among the student Teachers in arts and extract the various skills from them.</li>
            <li>Offering an opportunity for members to serve together productively and usefully.</li>
            <li>Developing better understanding and cooperation and coordination among the members of the faculty and student teachers.</li>
        </ul>
        <h2 class="infra-title"  style="font-family: Georgia, serif;   color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>Arts Club Members</b></h2>
                <table>
                    <thead>
                        <tr>
                            <th>S.No</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Mrs. P. SASIKALA, Assistant Professor in History</td>
                            <td>Member (Staff)</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>P. KALAISELVAN, II Year (History)</td>
                            <td>Secretary</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">6</td>
                            <td>G. SUSHMITHA, II Year (Commerce)</td>
                            <td>Treasurer</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">7</td>
                            <td>I Year & II Year Students</td>
                            <td>Members</td>
                        </tr>
                    </tbody>
                </table>
