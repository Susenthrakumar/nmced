...
<div class="breadcrumb-section" style="font-family: Georgia, serif">
    ...
    <div class="breadcrumbs">
        <a href="index.php">Home</a> /   Committees   </a>  / Guidance & Counseling Cell
    </div>
</div>
...
<div class="container" style="font-family: Georgia, serif">
    ...
    <div class="sidebar">
        ...
        <a href="guidance-counseling.php" style="text-decoration: none;"><button class="active">Guidance & Counseling Cell</button></a>
    ...
    <div class="main-content">
        <h2 class="infra-title" style="font-family: Georgia, serif;  text-align: center; color: rgb(201, 9, 9)"><b>Guidance & Counseling Cell</b></h2>
        ...
        <p style="font-family: Georgia, serif; text-align: justify; color: black; margin-top: 0px; text-indent: 30px;">
            The Institution has established special Cell for the Guidance and Counseling of the student teachers. This Cell addresses the diverse Socio-economic challenges and geographic backgrounds of the heterogeneous group. The cell provides guidance to the student Teachers to improve their overall personalities and help them to meet difficulties in their life. The following services are provided by the guidance and counseling cell of the college.
        </p>
        <h2 class="details-title" style="font-family: Georgia, serif; color: rgb(201, 9, 9)"><b>Objectivies</b></h2>
        <ul class="infra-details" style="font-family: Georgia, serif; text-align: justify;">      
            <li>To provide guidance to the student teachers on various options available in the course of their study.</li>
            <li>To identify and develop the student teachers' abilities and interests.</li>
            <li>To help the students solve their personal, educational, and psychological problems.</li>
            <li>To improve their attitude and behavior in order to meet challenges.</li>
            <li>To make awareness among the student teachers for their future profession.</li>
            <li>To provide information to the student teachers on the scope and relevance of any area irrespective of their field of interest.</li>
            <li>To recognize their strengths and overcome weaknesses.</li>
        </ul>   
        <h2 class="infra-title"  style="font-family: Georgia, serif;   color: rgb(201, 9, 9); margin-bottom: 10px;" ><b>Guidance & Counseling Cell Members</b></h2>
                <table>
                    <thead>
                        <tr>
                            <th>S.No</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Mr.R. KANNADHASAN, Assistant Professor in Mathematics                            </td>
                            <td>Members</td>
                        </tr>
                        <tr>
