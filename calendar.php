...
<div class="container" style="font-family: Georgia, serif">
    <div class="sidebar">
        ...
        <a href="calendar.php" style="text-decoration: none;"><button class="active">Academic Calendar</button></a>
    ...
    <div class="content">
        ...
        <div class="box-contain">
            <div class="body-contain">
                <a class="calendar-file-link" href="documents/calendar/Academic Calender   ENGLISH - 2024-2025.pdf" target="blank" >Academic Calendar</a>
            </div>
        </div>        
    </div>
</div>
